...
class SolidityVisitor(ParseTreeVisitor):
    ...
    def visitPlaceholderStatement(self, ctx:SolidityParser.PlaceholderStatementContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#PrefixOperation.
    def visitPrefixOperation(self, ctx:SolidityParser.PrefixOperationContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SolidityParser#KeywordPrefixOperation.
    def visitKeywordPrefixOperation(self, ctx:SolidityParser.KeywordPrefixOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#AddOperation.
    def visitAddOperation(self, ctx:SolidityParser.AddOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#Primary.
    def visitPrimary(self, ctx:SolidityParser.PrimaryContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#MulOperation.
    def visitMulOperation(self, ctx:SolidityParser.MulOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#PayableExpression.
    def visitPayableExpression(self, ctx:SolidityParser.PayableExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SolidityParser#NewExpression.
    def visitNewExpression(self, ctx:SolidityParser.NewExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#BitNotOperation.
    def visitBitNotOperation(self, ctx:SolidityParser.BitNotOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#NotOperation.
    def visitNotOperation(self, ctx:SolidityParser.NotOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#ModOperation.
    def visitModOperation(self, ctx:SolidityParser.ModOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#SuffixOperation.
    def visitSuffixOperation(self, ctx:SolidityParser.SuffixOperationContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#ValueExpression.
    def visitValueExpression(self, ctx:SolidityParser.ValueExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SolidityParser#ParenExpression.
    def visitParenExpression(self, ctx:SolidityParser.ParenExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#FunctionCallWithOptions.
    ...
    # Visit a parse tree produced by SolidityParser#visibilityKeyword.
    def visitVisibilityKeyword(self, ctx:SolidityParser.VisibilityKeywordContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SolidityParser#allKeywords.
    def visitAllKeywords(self, ctx:SolidityParser.AllKeywordsContext):
        return self.visitChildren(ctx)
